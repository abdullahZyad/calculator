              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Row(
                    children: [
                      ElevatedButton(onPressed: () {
                        setState(() {Calc.input = ""; Calc.screen = Calc.input;});},
                        style: ElevatedButton.styleFrom(
                      ...
                      ElevatedButton(onPressed: () {
                        setState(() {
                          if(Calc.isCalcable()) {
                            Calc.input += "%"; Calc.screen = Calc.input;
                          }
                        });},
                          style: ElevatedButton.styleFrom(
                              backgroundColor: const Color(0xff50717b)
                  ...
                  Row(
                    children: [
                      ElevatedButton(onPressed: () {
                        setState(() {Calc.input += "7";Calc.screen = Calc.input;});},
                          child: const Text("7", style: TextStyle(fontSize: 30))),
                      ElevatedButton(onPressed: () {
                        setState(() {Calc.input += "8";Calc.screen = Calc.input;});},
                          child: const Text("8", style: TextStyle(fontSize: 30))),
                      ElevatedButton(onPressed: () {
                        setState(() {Calc.input += "9";Calc.screen = Calc.input;});},
                  ...
                  Row(
                    children: [
                      ElevatedButton(onPressed: () {
                        setState(() {Calc.input += "4";Calc.screen = Calc.input;});},
                          child: const Text("4", style: TextStyle(fontSize: 30))),
                      ElevatedButton(onPressed: () {
                        setState(() {Calc.input += "5";Calc.screen = Calc.input;});},
                          child: const Text("5", style: TextStyle(fontSize: 30))),
                      ElevatedButton(onPressed: () {
                        setState(() {Calc.input += "6";Calc.screen = Calc.input;});},
                  ...
                  Row(
                    children: [
                      ElevatedButton(onPressed: () {
                        setState(() {Calc.input += "1";Calc.screen = Calc.input;});},
                          child: const Text("1", style: TextStyle(fontSize: 30))),
                      ElevatedButton(onPressed: () {
                        setState(() {Calc.input += "2";Calc.screen = Calc.input;});},
                          child: const Text("2", style: TextStyle(fontSize: 30))),
                      ElevatedButton(onPressed: () {
                        setState(() {Calc.input += "3";Calc.screen = Calc.input;});},
                  ...
                  Row(
                    children: [
                      ElevatedButton(onPressed: () {
                        setState(() {Calc.input += "0";Calc.screen = Calc.input;});},
                      ...
                      ElevatedButton(onPressed: () {
                        setState(() {
                          ...
                          child: const Text(".", style: TextStyle(fontSize: 30))),
                      ElevatedButton(onPressed: () {
                        setState(() {Calc.calcIt(); Calc.screen = "${Calc.output}";});},
                          style: ElevatedButton.styleFrom(
                              backgroundColor: const Color(0xffe49756)
                          ),
                          child: const Text("=", style: TextStyle(fontSize: 30))),
